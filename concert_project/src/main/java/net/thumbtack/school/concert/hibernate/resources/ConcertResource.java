package net.thumbtack.school.concert.hibernate.resources;


import net.thumbtack.school.concert.hibernate.daoimpl.DataDaoImpl;
import net.thumbtack.school.concert.hibernate.daoimpl.SongDaoImpl;
import net.thumbtack.school.concert.hibernate.daoimpl.UserDaoImpl;
import net.thumbtack.school.concert.hibernate.service.DataService;
import net.thumbtack.school.concert.hibernate.service.SongService;
import net.thumbtack.school.concert.hibernate.service.UserService;
...
public class ConcertResource {
    ...
    private static SongService songService = new SongService(new SongDaoImpl());
    private static DataService dataService = new DataService(new DataDaoImpl());
