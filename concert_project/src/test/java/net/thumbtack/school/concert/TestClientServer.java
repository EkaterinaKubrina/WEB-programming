...
public class TestClientServer {
    ...
    @BeforeAll()
    public static void start() throws ConfigurationException, MyException {
        setBaseUrl();
        Server.createServer();
    ...
    public void testRegister() {
        ...
        assertEquals(gson.toJson(allUsersDtoResponse1), gson.toJson(response1));
        ...
        assertEquals(gson.toJson(allUsersDtoResponse3), gson.toJson(response3));
    }
    ...
    public void testRegisterUserServerThreads1() throws InterruptedException {
        ...
        if (response1 instanceof AllUsersDtoResponse) {
            ...
            assertEquals(gson.toJson(allUsersDtoResponse), gson.toJson(allUsersDtoResponse1));
        } else {
    ...
    public void testSong() {
        ...
        assertEquals(gson.toJson(new AllSongsDtoResponse(Collections.singletonList(song))), gson.toJson(response2));
        ...
        assertEquals(gson.toJson(new AllSongsDtoResponse(new ArrayList<>())), gson.toJson(response3));
    }
    ...
    public void testSongError() {
        ...
        Object response3 = client.post(baseURL + "/song", gson.toJson(addSongDtoRequest), AddSongDtoResponse.class);
        checkFailureResponse(response3, ErrorCode.SONG_ALREADY_ADDED);
    ...
    public void testSongGet() {
        ...
        assertEquals(gson.toJson(new AllSongsDtoResponse(Arrays.asList(song, song1, song2))), gson.toJson(response4));


        Object response5 = client.get(baseURL + "/song/composer", AllSongsDtoResponse.class, token.getToken(), song.getComposers());
        assertEquals(gson.toJson(new AllSongsDtoResponse(Arrays.asList(song, song2))), gson.toJson(response5));

        Object response6 = client.get(baseURL + "/song/wordAuthors", AllSongsDtoResponse.class, token.getToken(), song2.getWordAuthors());
        assertEquals(gson.toJson(new AllSongsDtoResponse(Collections.singletonList(song2))), gson.toJson(response6));

        Object response7 = client.get(baseURL + "/song/wordAuthors/each", AllSongsDtoResponse.class, token.getToken(), song2.getWordAuthors());
        assertEquals(gson.toJson(new AllSongsDtoResponse(Arrays.asList(song, song2))), gson.toJson(response7));
    ...
    public void rating() {
        ...
        assertEquals(4.5, averageDtoResponse.getAverageRatingOfSong(),0.000001);
        ...
        assertEquals(5.0, averageDtoResponse1.getAverageRatingOfSong(),0.000001);
    ...
    public void comments() {
        ...
        assertEquals(gson.toJson(getCommentsDtoResponse), gson.toJson(response3));
        ...
        assertEquals(gson.toJson(getCommentsDtoResponse2), gson.toJson(response4));
    }
    ...
    public void usersAgree() {
        ...
        assertEquals(gson.toJson(getUsersAgreeDtoResponse), gson.toJson(response4));
